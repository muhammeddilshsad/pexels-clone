  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-2 sm:p-4">
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          {[
            ...
            <div
              key={i}
              className="mb-2 sm:mb-4 opacity-75 hover:opacity-90 transition-opacity cursor-pointer"
            >
              <img
                src={image.src}
                alt={`Background image ${i + 1}`}
      ...
      <div className="absolute top-0 left-0 right-0 flex items-center justify-between p-3 sm:p-6 z-20">
        <div className="flex items-center">
          <h1 className="text-xl sm:text-2xl font-bold text-black">pexels</h1>
        </div>
        <div className="flex items-center space-x-2 sm:space-x-4">
          <div className="hidden sm:flex items-center space-x-2">
            ...
            />
            <span className="text-black font-medium text-sm sm:text-base">English</span>
          </div>
          <button className="bg-black text-white px-3 py-1.5 sm:px-6 sm:py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors text-sm sm:text-base">
            Join
          </button>
        </div>
      </div>
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-4 sm:p-8 w-full max-w-sm sm:max-w-md mx-2 sm:mx-0">
        <h2 className="text-xl sm:text-2xl font-semibold text-center mb-6 sm:mb-8 text-gray-900">
          Welcome back.
        </h2>
        ...
        <div className="space-y-3 sm:space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => setEmail(e.target.value)}
              placeholder="name@email.com"
              className="w-full px-3 py-2.5 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-colors text-sm sm:text-base"
              required
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => setPassword(e.target.value)}
                placeholder="Password"
                className="w-full px-3 py-2.5 sm:px-4 sm:py-3 pr-10 sm:pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-colors text-sm sm:text-base"
                required
              />
              <button
                type="button"
          ...
          <button
            type="button"
            onClick={handleSubmit}
            className="w-full bg-green-500 text-white py-2.5 sm:py-3 px-4 rounded-lg font-medium hover:bg-green-600 transition-colors text-sm sm:text-base"
          >
            Log in
          </button>
          ...
          <button 
            ...
            className="w-full text-center text-sm sm:text-base text-gray-600 hover:text-gray-800 py-2 transition-colors"
          >
            Register
          </button>
        </div>
