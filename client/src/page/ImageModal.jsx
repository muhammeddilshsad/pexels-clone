    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex  items-center justify-center">
      <div className="bg-white rounded-lg max-w-xl w-full p-6 h- relative">
        ...
        <div className="flex space-x-4 mt-4">
          <button onClick={()=>handleDownload(image)} className="flex items-center space-x-1 text-sm text-white bg-black px-4 py-2 rounded hover:bg-gray-800">
      ...
      className={`flex items-center space-x-1 text-sm px-4 py-2 rounded border ${
        liked ? 'border-red-500 text-red-500 bg-red-50' : 'border-black text-black hover:bg-gray-100'
      }`}
    >
