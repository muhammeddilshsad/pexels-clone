      ...
      <div className="columns-1 md:columns-2 lg:columns-3 sl:columns-4 gap-6 space-y-6">
        {images.map((image) => (
          <div key={image._id} className="break-inside-avoid mb-6" >
            <div className="relative group cursor-pointer overflow-hidden rounded-lg bg-gray-100 shadow-md hover:shadow-sl transition-all duration-300" onClick={()=>onclick(image)}>
              <img
                src={image.imageUrl}
                alt={image.title}
